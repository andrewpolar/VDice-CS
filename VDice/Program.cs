...
//The training data is 2000 individual records from 1000 different populations.  When 
//trained, the model returns samples, 70% of which matches populations, it is determined
//by Cramer von Mises test. 
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < NTests; ++i)
            {
                ...
                Console.WriteLine("Passed Cramer von Mises tests {0} from {1} tests", passed_CVMs, i + 1);
            }
            mean_dist /= NTests;
